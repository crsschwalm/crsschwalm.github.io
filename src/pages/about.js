  ...
  <div id={id}>
    ...
    <section className="list-section">
      ...
      <div>
        ...
        <ul>
          <li>
            Public facing <strong>Web Apps</strong>
          </li>
          <ul>
            <li>
              Theres something that feels great about working on projects that
              you can show off to friends and family
            </li>
          </ul>
          <li>
            Mobile Development - <strong>React Native</strong>
          </li>
          <ul>
            <li>Built operational prototype application for client</li>
          </ul>
          <li>
            <strong>AWS</strong>... there's so many options
          </li>
          <ul>
